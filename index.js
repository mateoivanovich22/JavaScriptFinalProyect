...
const inputContrasenaInicioSesion = document.querySelector("#inputContrasenaInicioSesion");
...
formIniciarSesion.onsubmit = ( event ) => {
  ...
  .then( res => res.json())
  .then( data => {
    usuarioVerdadero = esUsuario(data, inputMailInicioSesion.value, inputContrasenaInicioSesion.value)
